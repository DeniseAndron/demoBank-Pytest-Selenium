...
def setup(browser):
    if browser == 'chrome':
        ...
        driver = webdriver.Firefox(executables.FIREFOX_EXECUTABLE_PATH, options=firefox_options)
    else:
        driver = webdriver.Edge(executables.EDGE_EXECUTABLE_PATH)
...
# Hook to delete/modify Enfironment info to HTML Report
